...
def main():
    ...
    if st.button("Predict"):
        ...
        st.markdown("<h1 style='text-align: right; color: blue; font-size: small;'><a href='https://github.com/Nishithkumar77/Gym-app.git'>Looking for Source Code?</a></h1>", unsafe_allow_html=True)
